...
public class DeleteActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dotProgressBar = (DotProgressBar)findViewById(R.id.dot_progress_bar4);
        dotProgressBar.setVisibility(View.VISIBLE);
        swipeRefreshLayout = (SwipeRefreshLayout)findViewById(R.id.refes3);
            ...
            public void onRefresh() {
                ...
                getdata.enqueue(new Callback<ResponModel>() {
                    ...
                    public void onResponse(Call<ResponModel> call, Response<ResponModel> response) {
                        ...
                        new CDialog(DeleteActivity.this).createAlert("Telah Di Refresh",
                        ...
                        adapter = new AdapterDelete(DeleteActivity.this,modelList);
                    ...
                    public void onFailure(Call<ResponModel> call, Throwable t) {
                        dotProgressBar.setVisibility(View.GONE);
                        new CDialog(DeleteActivity.this).createAlert("Gagal di refesh",
...
//                progressDialog.hide();
                dotProgressBar.setVisibility(View.GONE);
                new CDialog(DeleteActivity.this).createAlert("Berhasil",
                        CDConstants.SUCCESS, CDConstants.LARGE)
                        .setAnimation(CDConstants.SCALE_FROM_BOTTOM_TO_TOP)
                        .setDuration(2000)
                        .setPosition(CDConstants.CENTER)
...
//                progressDialog.hide();
                dotProgressBar.setVisibility(View.GONE);
                new CDialog(DeleteActivity.this).createAlert("Gagal",
                        CDConstants.ERROR, CDConstants.LARGE)
                        .setAnimation(CDConstants.SCALE_FROM_BOTTOM_TO_TOP)
                        .setDuration(2000)
                        .setPosition(CDConstants.CENTER)
